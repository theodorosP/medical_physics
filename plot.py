...
file = "3saSingles_paxys_crystallos.dat"
...
plt.scatter(dataset[columns[11]], dataset[columns[12]], label = "X - Y")
plt.ylabel("Y")
plt.xlabel("X")
plt.title("X vs Y")
plt.savefig("X_Y.png")
...
ax.scatter(dataset[columns[11]], dataset[columns[12]], dataset[columns[13]], c='b', marker='o')
ax.set_xlabel("X")
ax.set_ylabel("Y")
ax.set_zlabel("Z")
